...
export default function FutureLetterAppForm(props) {
    ...
    return React.createElement(
        ...
        React.createElement(
            ...
            React.createElement(
                'div',
                { className: 'future-letter-heading color-heading' },
                'Write a Letter!'
            ),
            React.createElement('input', { value: mailSubject, className: 'text-container', type: 'text', name: 'subject', placeholder: 'subject', onChange: handleSubject, onKeyDown: handleSubject, onKeyUp: handleSubject, required: true }),
            React.createElement(
                'div',
                { ref: contentref, className: 'future-letter-content-div text-container', onKeyDown: handleContent, onKeyUp: handleContent, contentEditable: 'true', suppressContentEditableWarning: 'true' },
                'Body'
            ),
