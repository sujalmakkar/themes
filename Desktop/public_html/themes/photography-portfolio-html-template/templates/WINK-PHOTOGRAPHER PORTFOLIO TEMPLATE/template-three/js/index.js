...
$(function(){
  ...
  gsap.to('.home-main-text',1,{opacity:0});
  gsap.to('.image-type',1,{opacity:0});
  gsap.to('.navigation-bar',1,{opacity:0});
  gsap.to('.slider-controls',1,{opacity:0});
      ...
      onComplete:function(){
        ...
        gsap.to('#loader',1.2,{   //LOADING PAGE TRANSITION
          ...
          onComplete:function(){
            ...
            gsap.to('.image-type',1,{opacity:1,ease:'ease',delay:1});
            gsap.to('.navigation-bar',.5,{opacity:1,delay:1.5});
            gsap.to('.slider-controls',.5,{opacity:1,delay:1.5});
            gsap.to('.about-link',.5,{opacity:1,delay:1.5});
            gsap.to('.home-main-text',1,{opacity:1,delay:1.5});
          }
      })
      }
    })
  ...
  // CURSOR
   $(function(){
    ...
    var $cursortwo = $('.cursor-two')
     ...
     $('#home .img-container im').hover(linkhover,cursor);
     $('.hover').hover(cursorhover,cursor);
     $('.page-link').hover(cursorhover,cursor);
  })
// CURSOR
